...
source_file <- paste("..", .Platform$file.sep, "oneToOneConcurrentTrafficResults.csv", sep = "")
target_file <- paste("graphs", .Platform$file.sep, "oneToOneConcurrentTrafficResults.pdf", sep = "")
