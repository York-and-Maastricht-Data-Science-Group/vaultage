package org.vaultage.wallet.uphold.test;
...
//		String personalAccessToken = wallet.createNewPersonalAccessToken(tokenDescription, usernameB, passwordB,
	...
	public void testMoneyTransferBetweenCards()
		...
		JsonNode accounts = wallet.getAccounts(accessToken);
		...
		JsonNode transaction = wallet.transfer(originCardId, destinationCardId, "USD", 0.01, accessToken, "Vaultage-Uphold Test", "Vaultage-Uphold Test");
...
//		String destinationCardId = "BrWBxMiLXmJA";
		...
		JsonNode transaction = wallet.transfer(originCardId, destinationCardId, "USD", 0.03, accessToken, "Vaultage-Uphold Test", "Vaultage-Uphold Test");
